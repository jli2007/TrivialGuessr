  ...
  return (
    <div className="min-h-screen md:max-h-full inset-0 z-50 bg-[url('/bg.jpg')] bg-cover bg-center flex items-center justify-center p-4 relative overflow-x-hidden overflow-y-auto md:overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-full">
        <svg viewBox="0 0 1200 300" className="w-full h-24 text-slate-700/20">
          <path
      ...
      <div className="relative z-10 min-h-screen md:max-h-full flex flex-col justify-center p-4 py-8">
        <div className="max-w-6xl w-full mx-auto">
          {/* Compact Header - Made Wider */}
          <div className="text-center mb-6">
            <div className="relative inline-block mb-4">
              ...
              <div className="relative bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur-xl rounded-2xl border border-yellow-500/20 shadow-lg px-12 py-6 min-w-[400px]">
                <div className="flex items-center justify-center gap-3 mb-3">
                  <div className="p-2 bg-gradient-to-br from-yellow-400/15 to-yellow-600/15 rounded-xl border border-yellow-400/20">
                    {scoreRank.icon}
                  </div>
                  <h2 className={`text-2xl font-bold ${scoreRank.color} font-odachi`}>
                    {scoreRank.rank}
                  </h2>
                </div>

                <h1 className="text-3xl md:text-4xl font-bold text-white mb-3 font-odachi">
                  Game Finished
                </h1>
                ...
                <div className="relative">
                  ...
                  <div className="relative text-4xl md:text-5xl font-black bg-gradient-to-r from-yellow-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-tight">
          ...
          {/* Widened Results Grid */}
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-6">
            {/* Round Results with custom scrollbar */}
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-xl border border-slate-600/40 shadow-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 bg-gradient-to-br from-amber-500/15 to-yellow-500/15 rounded-lg border border-amber-400/20">
                ...
                <div className="space-y-2 h-80 overflow-y-auto pr-2 custom-scrollbar">
                  {answers.map((answer, index) => (
                    <div key={index} className="group/item relative">
                      ...
                      <div className="relative bg-gradient-to-r from-slate-700/30 to-slate-800/30 rounded-lg p-3 border border-slate-600/20 hover:border-yellow-500/20 transition-all duration-300">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2">
                            <div className="w-6 h-6 bg-gradient-to-br from-yellow-400/20 to-amber-500/20 rounded-lg flex items-center justify-center border border-yellow-400/15">
                        ...
                        <div className="text-slate-300 mb-1 ml-8 font-medium text-sm">
                          {answer.correctAnswer}
                        </div>

                        <div className="text-slate-400 mb-1 ml-8 font-medium text-xs italic">
            ...
            {/* Performance Statistics - Fixed overflow */}
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-xl border border-slate-600/40 shadow-lg p-6 h-full">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 bg-gradient-to-br from-blue-500/15 to-purple-500/15 rounded-lg border border-blue-400/20">
                ...
                <div className="flex flex-col h-80 overflow-hidden">
                  ...
                  <div className="space-y-4 flex-1 overflow-y-auto custom-scrollbar">
                    ...
                    <div className="relative group/stat">
                      ...
                      <div className="relative flex justify-between items-center py-3 px-4 bg-gradient-to-r from-emerald-500/8 via-emerald-400/4 to-transparent rounded-lg border border-emerald-500/15">
                        <span className="text-white font-medium text-sm">
                          Perfect Shots (&lt;1km)
                        </span>
                    ...
                    <div className="relative group/stat">
                      ...
                      <div className="relative flex justify-between items-center py-3 px-4 bg-gradient-to-r from-yellow-500/8 via-yellow-400/4 to-transparent rounded-lg border border-yellow-500/15">
                        <span className="text-white font-medium text-sm">
                          Close Calls (&lt;100km)
                        </span>
                    ...
                    <div className="relative group/stat">
                      ...
                      <div className="relative flex justify-between items-center py-3 px-4 bg-gradient-to-r from-blue-500/8 via-blue-400/4 to-transparent rounded-lg border border-blue-500/15">
                        <span className="text-white font-medium text-sm">
                          Average Distance
                        </span>
                        <span
                          className={`font-bold text-lg ${getDistanceColor(
                            averageDistance
                          )}`}
                        >
                    ...
                    <div className="relative group/stat">
                      ...
                      <div className="relative flex justify-between items-center py-3 px-4 bg-gradient-to-r from-green-500/8 via-green-400/4 to-transparent rounded-lg border border-green-500/15">
                        <span className="text-white font-medium text-sm">
                          Best Performance
                        </span>
                  ...
                  {/* Compact grand total - always visible at bottom */}
                  <div className="pt-4 border-t border-slate-600/40 flex-shrink-0">
                    <div className="relative">
                      <div className="absolute inset-0 bg-gradient-to-r from-yellow-400/8 via-amber-400/8 to-yellow-400/8 rounded-lg blur" />
                      <div className="relative flex justify-between items-center py-4 px-5 bg-gradient-to-r from-yellow-500/15 via-amber-500/10 to-yellow-500/15 rounded-lg border border-yellow-400/25">
                        <span className="text-white font-bold text-base">
                          Final Score
                        </span>
                        <span className="text-yellow-300 font-black text-xl tracking-wide">
                          {score.toLocaleString()}
                        </span>
                      </div>
                    </div>
          ...
          <div className="text-center">
            ...
            >
              ...
              <div className="relative bg-gradient-to-r from-yellow-500 via-amber-500 to-yellow-500 hover:from-yellow-400 hover:via-amber-400 hover:to-yellow-400 text-slate-900 py-3 px-8 rounded-xl font-bold text-lg transition-all duration-300 group-hover:scale-105 shadow-lg flex items-center gap-3">
